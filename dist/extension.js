"use strict";var ee=Object.create;var G=Object.defineProperty;var te=Object.getOwnPropertyDescriptor;var ne=Object.getOwnPropertyNames;var re=Object.getPrototypeOf,oe=Object.prototype.hasOwnProperty;var se=(i,t)=>{for(var o in t)G(i,o,{get:t[o],enumerable:!0})},z=(i,t,o,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of ne(t))!oe.call(i,n)&&n!==o&&G(i,n,{get:()=>t[n],enumerable:!(s=te(t,n))||s.enumerable});return i};var k=(i,t,o)=>(o=i!=null?ee(re(i)):{},z(t||!i||!i.__esModule?G(o,"default",{value:i,enumerable:!0}):o,i)),ae=i=>z(G({},"__esModule",{value:!0}),i);var xe={};se(xe,{activate:()=>we,deactivate:()=>ye});module.exports=ae(xe);var p=k(require("vscode")),_=k(require("path")),x=k(require("fs")),D=k(require("os"));var l=k(require("vscode")),y=k(require("fs")),L=k(require("path")),Z=k(require("child_process"));var g=k(require("vscode")),q=k(require("os")),R=k(require("fs")),I=k(require("path"));var $={"":null,Dracula:{name:"Dracula",background:"#282a36",foreground:"#f8f8f2",cursor:"#f8f8f2",cursorAccent:"#282a36",selectionBackground:"#44475a",black:"#21222c",brightBlack:"#6272a4",red:"#ff5555",brightRed:"#ff6e6e",green:"#50fa7b",brightGreen:"#69ff94",yellow:"#f1fa8c",brightYellow:"#ffffa5",blue:"#bd93f9",brightBlue:"#d6acff",magenta:"#ff79c6",brightMagenta:"#ff92df",cyan:"#8be9fd",brightCyan:"#a4ffff",white:"#f8f8f2",brightWhite:"#ffffff"},Monokai:{name:"Monokai",background:"#272822",foreground:"#f8f8f2",cursor:"#f8f8f0",cursorAccent:"#272822",selectionBackground:"#49483e",black:"#272822",brightBlack:"#75715e",red:"#f92672",brightRed:"#f92672",green:"#a6e22e",brightGreen:"#a6e22e",yellow:"#f4bf75",brightYellow:"#f4bf75",blue:"#66d9ef",brightBlue:"#66d9ef",magenta:"#ae81ff",brightMagenta:"#ae81ff",cyan:"#a1efe4",brightCyan:"#a1efe4",white:"#f8f8f2",brightWhite:"#f9f8f5"},"Solarized Dark":{name:"Solarized Dark",background:"#002b36",foreground:"#839496",cursor:"#839496",cursorAccent:"#002b36",selectionBackground:"#073642",black:"#073642",brightBlack:"#586e75",red:"#dc322f",brightRed:"#cb4b16",green:"#859900",brightGreen:"#586e75",yellow:"#b58900",brightYellow:"#657b83",blue:"#268bd2",brightBlue:"#839496",magenta:"#d33682",brightMagenta:"#6c71c4",cyan:"#2aa198",brightCyan:"#93a1a1",white:"#eee8d5",brightWhite:"#fdf6e3"},"Solarized Light":{name:"Solarized Light",background:"#fdf6e3",foreground:"#657b83",cursor:"#657b83",cursorAccent:"#fdf6e3",selectionBackground:"#eee8d5",black:"#073642",brightBlack:"#586e75",red:"#dc322f",brightRed:"#cb4b16",green:"#859900",brightGreen:"#586e75",yellow:"#b58900",brightYellow:"#657b83",blue:"#268bd2",brightBlue:"#839496",magenta:"#d33682",brightMagenta:"#6c71c4",cyan:"#2aa198",brightCyan:"#93a1a1",white:"#eee8d5",brightWhite:"#fdf6e3"},Nord:{name:"Nord",background:"#2e3440",foreground:"#d8dee9",cursor:"#d8dee9",cursorAccent:"#2e3440",selectionBackground:"#434c5e",black:"#3b4252",brightBlack:"#4c566a",red:"#bf616a",brightRed:"#bf616a",green:"#a3be8c",brightGreen:"#a3be8c",yellow:"#ebcb8b",brightYellow:"#ebcb8b",blue:"#81a1c1",brightBlue:"#81a1c1",magenta:"#b48ead",brightMagenta:"#b48ead",cyan:"#88c0d0",brightCyan:"#8fbcbb",white:"#e5e9f0",brightWhite:"#eceff4"},"One Dark":{name:"One Dark",background:"#282c34",foreground:"#abb2bf",cursor:"#528bff",cursorAccent:"#282c34",selectionBackground:"#3e4451",black:"#282c34",brightBlack:"#5c6370",red:"#e06c75",brightRed:"#e06c75",green:"#98c379",brightGreen:"#98c379",yellow:"#e5c07b",brightYellow:"#d19a66",blue:"#61afef",brightBlue:"#61afef",magenta:"#c678dd",brightMagenta:"#c678dd",cyan:"#56b6c2",brightCyan:"#56b6c2",white:"#abb2bf",brightWhite:"#ffffff"},"Gruvbox Dark":{name:"Gruvbox Dark",background:"#282828",foreground:"#ebdbb2",cursor:"#ebdbb2",cursorAccent:"#282828",selectionBackground:"#504945",black:"#282828",brightBlack:"#928374",red:"#cc241d",brightRed:"#fb4934",green:"#98971a",brightGreen:"#b8bb26",yellow:"#d79921",brightYellow:"#fabd2f",blue:"#458588",brightBlue:"#83a598",magenta:"#b16286",brightMagenta:"#d3869b",cyan:"#689d6a",brightCyan:"#8ec07c",white:"#a89984",brightWhite:"#ebdbb2"},"Tokyo Night":{name:"Tokyo Night",background:"#1a1b26",foreground:"#a9b1d6",cursor:"#c0caf5",cursorAccent:"#1a1b26",selectionBackground:"#33467c",black:"#15161e",brightBlack:"#414868",red:"#f7768e",brightRed:"#f7768e",green:"#9ece6a",brightGreen:"#9ece6a",yellow:"#e0af68",brightYellow:"#e0af68",blue:"#7aa2f7",brightBlue:"#7aa2f7",magenta:"#bb9af7",brightMagenta:"#bb9af7",cyan:"#7dcfff",brightCyan:"#7dcfff",white:"#a9b1d6",brightWhite:"#c0caf5"}},U=Object.keys($);function M(i){let t=$[i];if(!t)return null;let{name:o,...s}=t;return s}function B(i){return new Promise(t=>setTimeout(t,i))}var ie=3e3,le=15e3,de=200,ce=[/[❯>✻⏵›]\s*$/m,/aider>\s*$/m],W=(()=>{if(process.platform!=="win32")return 0;let i=q.release().split(".");return parseInt(i[2]||"0",10)})(),H=W>0&&W<22e3?"\r":"\x1B[13u",pe=["claude","codex","gemini","copilot","aider","claude --dangerously-skip-permissions","codex -s danger-full-access -a never"];function A(i){let t=i.trim();return pe.some(o=>t===o||t.startsWith(o+" "))}function ge(i){let t=i.toLowerCase();return t.includes("powershell")||t.includes("pwsh")||t.includes("cmd")?`\r
`:"\r"}function J(i,t,o,s,n){let e=i[n];return e?.startupSteps&&e.startupSteps.length>0?e.startupSteps:e?.startupCommand?[{type:"command",input:e.startupCommand}]:t[n]?[{type:"command",input:t[n]}]:o.length>0?o:s?[{type:"command",input:s}]:[]}var V={".ttf":"truetype",".otf":"opentype",".woff":"woff",".woff2":"woff2"},f=class i{constructor(t,o,s,n){this._terminals=[];this._outputBuffers=[];this._csiUMode=[];this._insideLlm=[];this._cellShellType=[];this._cellStatus=[];this._disposed=!1;this._stepGeneration={};this._panel=t,this._context=o,this._rows=s,this._cols=n;let e=o.globalState.get("mergedRegions",[]).filter(r=>r.startRow+r.rowSpan<=s&&r.startCol+r.colSpan<=n);this._hiddenCells=new Set;for(let r of e)for(let a=r.startRow;a<r.startRow+r.rowSpan;a++)for(let d=r.startCol;d<r.startCol+r.colSpan;d++)a===r.startRow&&d===r.startCol||this._hiddenCells.add(a*n+d);this._panel.webview.options={enableScripts:!0,localResourceRoots:[g.Uri.joinPath(o.extensionUri,"media")]},this._panel.webview.html=this._getHtml(),this._panel.webview.onDidReceiveMessage(async r=>{switch(r.type){case"ready":if(this._createTerminals(r.defaultCols,r.defaultRows),r.cellDims&&Array.isArray(r.cellDims))for(let d=0;d<r.cellDims.length&&d<this._terminals.length;d++){let c=r.cellDims[d];if(c?.cols&&c?.rows)try{this._terminals[d].pty.resize(c.cols,c.rows)}catch{}}this.loadCustomFonts(this._context.globalState.get("customFonts",[]));let a=this._context.globalState.get("cellOverrides",{});for(let[d,c]of Object.entries(a))if(c.bgColor||c.fgColor||c.fontFamily||c.themeName){let u=c.themeName?M(c.themeName):null;this.sendCellConfig(parseInt(d),c.bgColor||"",c.fgColor||"",c.fontFamily||"",c.themeName||"",u)}break;case"input":{let d=this._terminals[r.id]?.pty;d&&this._chunkedWrite(d,r.data);break}case"clipboardWrite":g.env.clipboard.writeText(r.text);break;case"resize":try{this._terminals[r.id]?.pty.resize(r.cols,r.rows)}catch{}break;case"clearTerminal":this._panel.webview.postMessage({type:"clear",id:r.id});break;case"killTerminal":try{this._terminals[r.id]?.pty.kill()}catch{}break;case"restartTerminal":this._restartTerminal(r.id);break;case"renameCell":{let d=this._context.globalState.get("cellLabels",[]),c=d[r.id]||"",u=await g.window.showInputBox({prompt:g.l10n.t("Rename cell {0}",r.id+1),value:c,placeHolder:g.l10n.t("Enter alias (empty to reset)")});u!==void 0&&(d[r.id]=u,await this._context.globalState.update("cellLabels",d),this.sendLabels(),g.commands.executeCommand("terminalGrid._refreshSidebar"));break}}}),this._configListener=g.workspace.onDidChangeConfiguration(r=>{if(r.affectsConfiguration("terminalGrid")||r.affectsConfiguration("terminal.integrated")||r.affectsConfiguration("editor")){let a=g.workspace.getConfiguration("terminalGrid"),d=g.workspace.getConfiguration("terminal.integrated"),c=g.workspace.getConfiguration("editor"),u=a.get("colorTheme",""),h=d.get("fontFamily")||c.get("fontFamily")||"";this._panel.webview.postMessage({type:"configUpdate",zoom:a.get("zoomPercent",100),fontFamily:a.get("fontFamily",""),ideFontFamily:h,bgColor:a.get("backgroundColor",""),fgColor:a.get("foregroundColor",""),themeName:u,themeColors:M(u)})}}),this._panel.onDidDispose(()=>this.dispose()),this._panel.iconPath=g.Uri.joinPath(o.extensionUri,"images","sidebar.svg")}static{this.OUTPUT_BUFFER_SIZE=5e4}static{this.CSI_U_ENABLE=/\x1b\[>[0-9]+u/}static{this.CSI_U_DISABLE=/\x1b\[<[0-9]*u/}static _getLog(){return i._log||(i._log=g.window.createOutputChannel("Terminal Grid")),i._log}_updateCellStatus(t,o){this._disposed||(this._cellStatus[t]=o,this._panel.webview.postMessage({type:"setStatus",id:t,status:o}))}static _getNodePty(){if(i._nodePty===void 0)try{i._nodePty=require("node-pty"),i._ensureNodePtySpawnHelperExecutable()}catch{i._nodePty=null}return i._nodePty}static _ensureNodePtySpawnHelperExecutable(){if(process.platform==="darwin")try{let t=require.resolve("node-pty/package.json"),o=I.dirname(t),s=I.join(o,"prebuilds",`darwin-${process.arch}`,"spawn-helper");if(!R.existsSync(s))return;let n=R.statSync(s);if((n.mode&73)!==0)return;R.chmodSync(s,n.mode|493),i._getLog().appendLine(`[_getNodePty] fixed executable bit on "${s}"`)}catch(t){i._getLog().appendLine(`[_getNodePty] could not fix node-pty spawn-helper permissions: ${t instanceof Error?t.message:String(t)}`)}}static _resolveCommandPath(t){let o=t.trim();if(!o)return null;try{if(/[/\\]/.test(o))return R.existsSync(o)?o:null}catch{return null}if(process.platform!=="win32")for(let s of["/bin","/usr/bin","/usr/local/bin","/opt/homebrew/bin"]){let n=I.join(s,o);try{if(R.existsSync(n))return n}catch{}}try{let s=require("child_process"),n=process.platform==="win32"?"where":"which";return s.execFileSync(n,[o],{encoding:"utf8",stdio:["ignore","pipe","ignore"],timeout:500}).split(/\r?\n/).map(a=>a.trim()).find(Boolean)||null}catch{return null}}static _defaultShell(t){if(process.platform==="win32"){let s=i._resolveCommandPath("pwsh.exe")||i._resolveCommandPath("powershell.exe");if(s)return t?.appendLine(`[_defaultShell] -> using powershell: "${s}"`),{path:s,args:["-NoLogo","-NoProfile"]};let n=process.env.COMSPEC||i._resolveCommandPath("cmd.exe")||"cmd.exe";return t?.appendLine(`[_defaultShell] -> using cmd: "${n}"`),{path:n,args:[]}}let o=process.env.SHELL;if(o){let s=i._resolveCommandPath(o);if(s)return t?.appendLine(`[_defaultShell] -> using SHELL: "${s}"`),{path:s,args:[]};t?.appendLine(`[_defaultShell] -> SHELL not usable: "${o}"`)}for(let s of["/bin/zsh","/bin/bash","/bin/sh"]){let n=i._resolveCommandPath(s);if(n)return t?.appendLine(`[_defaultShell] -> using fallback: "${n}"`),{path:n,args:[]}}return t?.appendLine('[_defaultShell] -> using final fallback: "/bin/sh"'),{path:"/bin/sh",args:[]}}static getAvailableShells(){let t=[{name:"IDE Default",path:"",args:[]}];try{let n=function(d){return i._resolveCommandPath(d)!==null};var o=n;let s=new Set,e=process.platform==="win32"?"windows":process.platform==="darwin"?"osx":"linux",r=g.workspace.getConfiguration(`terminal.integrated.profiles.${e}`);if(r)for(let d of Object.keys(r))try{let c=r.get(d);if(!c||typeof c!="object")continue;let u=Array.isArray(c.path)?c.path[0]:c.path;u&&n(u)&&(t.push({name:d,path:u,args:c.args||[]}),s.add(u.toLowerCase()))}catch{}let a=process.platform==="win32"?[{name:"PowerShell",path:"powershell.exe",args:["-NoLogo"]},{name:"PowerShell 7",path:"pwsh.exe",args:["-NoLogo"]},{name:"Command Prompt",path:"cmd.exe",args:[]},{name:"Git Bash",path:"C:\\Program Files\\Git\\bin\\bash.exe",args:["--login"]},{name:"WSL",path:"wsl.exe",args:[]}]:[{name:"Bash",path:"/bin/bash",args:["--login"]},{name:"Zsh",path:"/bin/zsh",args:["--login"]},{name:"Fish",path:"/usr/bin/fish",args:[]},{name:"sh",path:"/bin/sh",args:[]}];for(let d of a)!s.has(d.path.toLowerCase())&&n(d.path)&&(t.push(d),s.add(d.path.toLowerCase()))}catch{}return t}_resolveShell(t){let o=i._getLog(),s=(t||"").trim();if(o.appendLine(`[_resolveShell] shellType="${s}"`),!s||s.toLowerCase()==="ide default")return i._defaultShell(o);let n=i.getAvailableShells(),e=s.toLowerCase(),r=n.find(c=>c.path.toLowerCase()===e||c.name.toLowerCase()===e||I.basename(c.path).toLowerCase()===e);if(r&&r.path)return o.appendLine(`[_resolveShell] -> matched: "${r.path}"`),{path:r.path,args:r.args};let a=i._resolveCommandPath(s);if(!a)return o.appendLine(`[_resolveShell] -> requested shell not found, falling back: "${s}"`),i._defaultShell(o);let d=a.toLowerCase();return d.includes("powershell")||d.includes("pwsh")?(o.appendLine(`[_resolveShell] -> direct path powershell: "${a}"`),{path:a,args:["-NoLogo"]}):d.includes("bash")||d.includes("zsh")?(o.appendLine(`[_resolveShell] -> direct path bash/zsh: "${a}"`),{path:a,args:["--login"]}):(o.appendLine(`[_resolveShell] -> direct path (no match): "${a}"`),{path:a,args:[]})}static createOrShow(t,o,s){i.currentPanel&&i.currentPanel.dispose();let n=g.window.createWebviewPanel("terminalGrid",g.l10n.t("Terminal Grid {0}\xD7{1}",o,s),g.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!0,localResourceRoots:[g.Uri.joinPath(t.extensionUri,"media")]});i.currentPanel=new i(n,t,o,s),t.globalState.update("lastGrid",{rows:o,cols:s}),g.commands.executeCommand("terminalGrid._refreshSidebar")}static revive(t,o,s,n){i.currentPanel&&i.currentPanel.dispose(),i.currentPanel=new i(t,o,s,n),o.globalState.update("lastGrid",{rows:s,cols:n}),g.commands.executeCommand("terminalGrid._refreshSidebar")}_enterSeq(t){return this._csiUMode[t]||this._insideLlm[t]?H:ge(this._cellShellType[t]||"")}broadcastInput(t){for(let o of this._terminals)if(!this._hiddenCells.has(o.id)){if(this._insideLlm[o.id])this._typeToCell(o.id,t).then(()=>B(50)).then(()=>{o.pty.write(this._enterSeq(o.id))});else{let n=/\r?\n/.test(t)?"\x1B[200~"+t+"\x1B[201~":t;o.pty.write(n+this._enterSeq(o.id))}A(t)&&(this._insideLlm[o.id]=!0),t.trim()==="exit"&&(this._insideLlm[o.id]=!1)}}sendToCell(t,o){let s=this._terminals[t];return s?(this._chunkedWrite(s.pty,o),!0):!1}sendInputToCell(t,o){let s=this._terminals[t];if(!s)return!1;if(this._insideLlm[t])this._typeToCell(t,o).then(()=>B(50)).then(()=>{s.pty.write(this._enterSeq(t))});else{let e=/\r?\n/.test(o)?"\x1B[200~"+o+"\x1B[201~":o;s.pty.write(e+this._enterSeq(t))}return A(o)&&(this._insideLlm[t]=!0),o.trim()==="exit"&&(this._insideLlm[t]=!1),!0}static _stripAnsi(t){return t.replace(/\x1b\[[0-9;?]*[a-zA-Z]/g,"").replace(/\x1b\][^\x07\x1b]*(?:\x07|\x1b\\)/g,"").replace(/\x1b[()][0-9A-Z]/g,"").replace(/\x1b[78DEHM]/g,"").replace(/[\x00-\x08\x0b\x0c\x0e-\x1f]/g,"").replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\n{3,}/g,`

`)}readCell(t,o){if(this._hiddenCells.has(t))return null;let s=this._outputBuffers[t];if(s===void 0)return null;let n=i._stripAnsi(s);return o===void 0?n:o<=0?"":n.split(`
`).slice(-o).join(`
`)}getCellCount(){return this._terminals.length}getRows(){return this._rows}getCols(){return this._cols}getCellLabels(){let t=this._context.globalState.get("cellLabels",[]),o=this._rows*this._cols;return Array.from({length:o},(s,n)=>t[n]||String(n+1))}sendCellConfig(t,o,s,n,e,r){this._panel.webview.postMessage({type:"cellConfig",id:t,bgColor:o,fgColor:s,fontFamily:n,themeName:e??"",themeColors:r??null})}clearCellOverrides(){this._panel.webview.postMessage({type:"clearCellOverrides"})}sendLabels(){let t=this._context.globalState.get("cellLabels",[]);this._panel.webview.postMessage({type:"setLabels",labels:t})}loadCustomFonts(t){for(let o of t){let s=this._readFontBase64(o.path);if(s){let n=I.extname(o.path).toLowerCase();this._panel.webview.postMessage({type:"loadFont",name:o.name,data:s,format:V[n]||"truetype"})}}}_readFontBase64(t){try{return R.readFileSync(t).toString("base64")}catch{return null}}_spawnPty(t,o,s,n,e){let r=this._resolveShell(e),a=i._getLog();a.appendLine(`[_spawnPty] shellType param="${e}", resolved path="${r.path}", args=${JSON.stringify(r.args)}`);let d=b=>{if(!t)throw new Error("node-pty unavailable");let v=t.spawn(b.path,b.args,{name:"xterm-256color",cols:o,rows:s,cwd:n,env:process.env});return{onData:m=>{v.onData(m)},write:m=>v.write(m),resize:(m,C)=>v.resize(m,C),kill:()=>v.kill()}};if(t)try{return d(r)}catch(b){a.appendLine(`[_spawnPty] node-pty failed for "${r.path}": ${b instanceof Error?b.message:String(b)}`);let v=i._defaultShell(a);if(v.path!==r.path)try{return a.appendLine(`[_spawnPty] retrying node-pty with fallback "${v.path}"`),d(v)}catch(m){a.appendLine(`[_spawnPty] fallback node-pty failed: ${m instanceof Error?m.message:String(m)}`)}g.window.showWarningMessage(g.l10n.t("Terminal Grid could not start the configured shell. Falling back to basic shell."))}let{spawn:c}=require("child_process"),u=i._defaultShell(a),h=c(u.path,u.args,{cwd:n,env:process.env,windowsHide:!0});return{onData:b=>{h.stdout?.on("data",v=>b(v.toString())),h.stderr?.on("data",v=>b(v.toString())),h.on("error",v=>{a.appendLine(`[_spawnPty] child_process fallback failed: ${v.message}`),b(`Terminal Grid failed to start shell: ${v.message}\r
`)})},write:b=>{h.stdin?.write(b)},resize:()=>{},kill:()=>h.kill()}}_createTerminals(t,o){let s=g.workspace.workspaceFolders?.[0]?.uri.fsPath||process.env.USERPROFILE||process.env.HOME||".",n=this._rows*this._cols,e=i._getNodePty();e||g.window.showWarningMessage(g.l10n.t("node-pty not available. Falling back to basic shell (limited features)."));let r=this._context.globalState.get("startupCommands",[]),a=[];for(let m of r)if(typeof m=="string")a.push(m);else if(m&&typeof m=="object"&&"command"in m){let C=m;for(let T=0;T<(C.count||1);T++)a.push(C.command)}let d=this._context.globalState.get("defaultCommand",""),c=this._context.globalState.get("defaultSteps",[]),u=t||80,h=o||24,b=g.workspace.getConfiguration("terminalGrid").get("shellType",""),v=this._context.globalState.get("cellOverrides",{});for(let m=0;m<n;m++){if(this._hiddenCells.has(m)){let E={onData(){},write(){},resize(){},kill(){}};this._terminals.push({id:m,pty:E}),this._outputBuffers[m]="",this._cellShellType[m]="",this._insideLlm[m]=!1,this._csiUMode[m]=!1;continue}let C=v[m]?.shellType||b||"",T=this._spawnPty(e,u,h,s,C||void 0),w=m,S=J(v,a,c,d,m);this._cellShellType[w]=C,this._insideLlm[w]=!1,this._outputBuffers[w]="",this._csiUMode[w]=!1,this._cellStatus[w]="idle";let P=!1;T.onData(E=>{this._disposed||(i.CSI_U_ENABLE.test(E)&&(this._csiUMode[w]=!0),i.CSI_U_DISABLE.test(E)&&(this._csiUMode[w]=!1),this._outputBuffers[w]=(this._outputBuffers[w]||"")+E,this._outputBuffers[w].length>i.OUTPUT_BUFFER_SIZE&&(this._outputBuffers[w]=this._outputBuffers[w].slice(-i.OUTPUT_BUFFER_SIZE)),this._panel.webview.postMessage({type:"output",id:w,data:E}),P||(P=!0,S.length>0?(this._updateCellStatus(w,"startup"),this._executeSteps(w,S,this._cellShellType[w]||"")):this._updateCellStatus(w,"active")))}),this._terminals.push({id:m,pty:T})}this.sendLabels()}_restartTerminal(t){let o=this._terminals[t];if(!o)return;try{o.pty.kill()}catch{}this._panel.webview.postMessage({type:"reset",id:t});let s=g.workspace.workspaceFolders?.[0]?.uri.fsPath||process.env.USERPROFILE||process.env.HOME||".",n=g.workspace.getConfiguration("terminalGrid").get("shellType",""),e=this._context.globalState.get("cellOverrides",{}),r=e[t]?.shellType||n||"",a=this._spawnPty(i._getNodePty(),80,24,s,r||void 0),d=this._context.globalState.get("startupCommands",[]),c=[];for(let m of d)if(typeof m=="string")c.push(m);else if(m&&typeof m=="object"&&"command"in m){let C=m;for(let T=0;T<(C.count||1);T++)c.push(C.command)}let u=this._context.globalState.get("defaultCommand",""),h=this._context.globalState.get("defaultSteps",[]),b=J(e,c,h,u,t);this._cellShellType[t]=r,this._insideLlm[t]=!1;let v=!1;this._outputBuffers[t]="",this._csiUMode[t]=!1,this._cellStatus[t]="idle",a.onData(m=>{this._disposed||(i.CSI_U_ENABLE.test(m)&&(this._csiUMode[t]=!0),i.CSI_U_DISABLE.test(m)&&(this._csiUMode[t]=!1),this._outputBuffers[t]=(this._outputBuffers[t]||"")+m,this._outputBuffers[t].length>i.OUTPUT_BUFFER_SIZE&&(this._outputBuffers[t]=this._outputBuffers[t].slice(-i.OUTPUT_BUFFER_SIZE)),this._panel.webview.postMessage({type:"output",id:t,data:m}),v||(v=!0,b.length>0?(this._updateCellStatus(t,"startup"),this._executeSteps(t,b,this._cellShellType[t]||"")):this._updateCellStatus(t,"active")))}),this._terminals[t]={id:t,pty:a}}static{this.CHUNK_SIZE=65536}_chunkedWrite(t,o){if(o.length<=i.CHUNK_SIZE){t.write(o);return}let s=0,n=()=>{if(s>=o.length)return;let e=o.slice(s,s+i.CHUNK_SIZE);s+=i.CHUNK_SIZE,t.write(e),s<o.length&&setTimeout(n,5)};n()}async _typeToCell(t,o){let s=this._terminals[t]?.pty;if(s)for(let n of o)s.write(n),await B(20)}static{this.LLM_TYPE_MAX_RETRIES=5}static{this.LLM_ECHO_WAIT=2e3}async _waitForLlmPrompt(t){let o=(this._outputBuffers[t]||"").length,s=Date.now()+le;for(;Date.now()<s;){await B(de);let n=this._outputBuffers[t]||"",e=i._stripAnsi(n.slice(o));if(ce.some(r=>r.test(e)))return!0;if(this._disposed)return!1}return!1}async _typeWithRetry(t,o){let s=this._terminals[t]?.pty;if(!s)return!1;for(let n=0;n<i.LLM_TYPE_MAX_RETRIES;n++){let e=(this._outputBuffers[t]||"").length;await this._typeToCell(t,o);let r=Date.now()+i.LLM_ECHO_WAIT;for(;Date.now()<r;){await B(50);let a=this._outputBuffers[t]||"";if(i._stripAnsi(a.slice(e)).includes(o))return!0;if(this._disposed)return!1}for(let a=0;a<o.length;a++)s.write("\x7F");await B(300)}return!1}async _executeSteps(t,o,s){this._stepGeneration[t]||(this._stepGeneration[t]=0);let n=++this._stepGeneration[t],e=!1;for(let r=0;r<o.length;r++){if(this._disposed||this._stepGeneration[t]!==n)return;let a=o[r];if(a.type==="timeout")await B(a.ms);else if(a.type==="command"){if(r>0&&(e?await this._waitForLlmPrompt(t):o[r-1].type==="command"&&await B(ie)),this._disposed||this._stepGeneration[t]!==n)return;let d=e?H:this._enterSeq(t);e?(await this._typeWithRetry(t,a.input),this._terminals[t]?.pty.write(d)):this._terminals[t]?.pty.write(a.input+d),A(a.input)&&(e=!0),a.input.trim()==="exit"&&(e=!1),this._insideLlm[t]=e}}this._updateCellStatus(t,"active")}restartCell(t){this._restartTerminal(t)}restartAllCells(){for(let t of this._terminals)this._restartTerminal(t.id)}dispose(){this._disposed=!0,i.currentPanel=void 0,this._configListener?.dispose(),this._context.globalState.update("lastGrid",void 0);for(let t of this._terminals)try{t.pty.kill()}catch{}this._terminals=[],this._panel.dispose()}_buildCustomFontCss(){let t=this._context.globalState.get("customFonts",[]),o="";for(let s of t){let n=this._readFontBase64(s.path);if(!n)continue;let e=I.extname(s.path).toLowerCase(),r=V[e]||"truetype";o+=`@font-face { font-family: '${s.name}'; src: url(data:font/${e.slice(1)};base64,${n}) format('${r}'); font-display: swap; }
`}return o}_getHtml(){let t=this._panel.webview,o=t.asWebviewUri(g.Uri.joinPath(this._context.extensionUri,"media","gridTerminal.js")),s=t.asWebviewUri(g.Uri.joinPath(this._context.extensionUri,"media","xterm.css")),n=ue(),e=this._buildCustomFontCss();return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`}};function ue(){let i="",t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";for(let o=0;o<32;o++)i+=t.charAt(Math.floor(Math.random()*t.length));return i}var me=[".ttf",".otf",".woff",".woff2"];function fe(){try{return require("node-pty"),!0}catch{return!1}}var N=class{constructor(t){this._mcpPort=0;this._context=t}static{this.viewType="terminalGrid.sidebarView"}setMcpPort(t){this._mcpPort=t,this._view?.webview.postMessage({type:"mcpPort",port:t})}_getPresetFolderPath(){let t=l.workspace.workspaceFolders?.[0];if(t)return L.join(t.uri.fsPath,"terminal-grid")}_listLocalPresets(){let t=this._getPresetFolderPath();if(!t||!y.existsSync(t))return[];try{let o=y.readdirSync(t),s=[];for(let n of o)if(n.endsWith(".json"))try{let e=y.readFileSync(L.join(t,n),"utf-8"),r=JSON.parse(e);r.name&&s.push(r)}catch(e){console.error(`Failed to parse preset file: ${n}`,e)}return s}catch(o){return console.error("Failed to list local presets",o),[]}}_loadLocalPreset(t){let o=this._getPresetFolderPath();if(!o)return;let s=L.join(o,`${t}.json`);if(y.existsSync(s))try{let n=y.readFileSync(s,"utf-8");return JSON.parse(n)}catch(n){console.error(`Failed to load preset: ${t}`,n)}}async _saveLocalPreset(t,o){let s=this._getPresetFolderPath();if(!s){l.window.showWarningMessage(l.l10n.t("Please open a workspace folder first."));return}try{y.existsSync(s)||y.mkdirSync(s,{recursive:!0});let n=L.join(s,`${t}.json`);y.writeFileSync(n,JSON.stringify(o,null,2),"utf-8")}catch(n){l.window.showErrorMessage(`Failed to save preset: ${n}`)}}async _deleteLocalPreset(t){let o=this._getPresetFolderPath();if(!o)return;let s=L.join(o,`${t}.json`);if(y.existsSync(s))try{y.unlinkSync(s)}catch(n){l.window.showErrorMessage(`Failed to delete preset: ${n}`)}}async _linkPresetToProject(t){let o=l.workspace.workspaceFolders?.[0];if(!o)return;let s=o.uri.fsPath,n=this._context.globalState.get("projectPresets",{});n[s]=t,await this._context.globalState.update("projectPresets",n)}async _saveWorkspaceConfig(t,o){let s=this._getPresetFolderPath();if(s)try{y.existsSync(s)||y.mkdirSync(s,{recursive:!0});let n=l.workspace.getConfiguration("terminalGrid");t!==void 0&&await n.update("defaultRows",t,l.ConfigurationTarget.Global),o!==void 0&&await n.update("defaultCols",o,l.ConfigurationTarget.Global);let e={name:"terminal-grid",rows:t??n.get("defaultRows",3),cols:o??n.get("defaultCols",3),startupCommands:this._context.globalState.get("startupCommands",[]),cellLabels:this._context.globalState.get("cellLabels",[]),zoomPercent:n.get("zoomPercent",100),fontFamily:n.get("fontFamily",""),bgColor:n.get("backgroundColor",""),fgColor:n.get("foregroundColor",""),colorTheme:n.get("colorTheme",""),shellType:n.get("shellType",""),defaultCommand:this._context.globalState.get("defaultCommand",""),defaultSteps:this._context.globalState.get("defaultSteps",[]),cellStepsOverrides:this._context.globalState.get("cellOverrides",{}),mergedRegions:this._context.globalState.get("mergedRegions",[])},r=L.join(s,"terminal-grid.json");y.writeFileSync(r,JSON.stringify(e,null,2),"utf-8")}catch(n){console.error("Failed to auto-save workspace config",n)}}resolveWebviewView(t,o,s){this._view=t,t.webview.options={enableScripts:!0,localResourceRoots:[this._context.extensionUri]},t.webview.html=this._getHtml(),t.webview.onDidReceiveMessage(async n=>{switch(n.type){case"openGrid":{let e=l.workspace.getConfiguration("terminalGrid");await e.update("defaultRows",n.rows,l.ConfigurationTarget.Global),await e.update("defaultCols",n.cols,l.ConfigurationTarget.Global),await this._saveWorkspaceConfig(n.rows,n.cols),await l.commands.executeCommand("terminalGrid.openCustomGrid",n.rows,n.cols),this.sendConfig();break}case"reopenGrid":{let e=f.currentPanel,r=l.workspace.getConfiguration("terminalGrid"),a=e?e.getRows():r.get("defaultRows",2),d=e?e.getCols():r.get("defaultCols",3);await l.commands.executeCommand("terminalGrid.openCustomGrid",a,d),this.sendConfig();break}case"reload":await l.commands.executeCommand("workbench.action.reloadWindow");break;case"setConfig":{let e=l.workspace.getConfiguration("terminalGrid");n.key&&n.value!==void 0&&await e.update(n.key,n.value,l.ConfigurationTarget.Global),n.key==="shellType"&&f.currentPanel&&f.currentPanel.restartAllCells(),await this._saveWorkspaceConfig();break}case"getConfig":{this.sendConfig();break}case"browseFont":{let e=await l.window.showOpenDialog({canSelectMany:!1,filters:{"Font Files":["ttf","otf","woff","woff2"]},title:l.l10n.t("Select Font File")});if(!e||e.length===0)break;let r=e[0].fsPath,a=L.extname(r).toLowerCase();if(!me.includes(a)){l.window.showWarningMessage(l.l10n.t("Unsupported font format. Use .ttf, .otf, .woff, or .woff2"));break}try{y.accessSync(r,y.constants.R_OK)}catch{l.window.showErrorMessage(l.l10n.t("Cannot read font file."));break}let d=L.basename(r,a),c=this._context.globalState.get("customFonts",[]);c.some(u=>u.path===r)||(c.push({name:d,path:r}),await this._context.globalState.update("customFonts",c)),await this._saveWorkspaceConfig(),this.sendConfig(),f.currentPanel&&f.currentPanel.loadCustomFonts([{name:d,path:r}]);break}case"removeFont":{let r=this._context.globalState.get("customFonts",[]).filter(a=>a.name!==n.name);await this._context.globalState.update("customFonts",r),await this._saveWorkspaceConfig(),this.sendConfig();break}case"addStartupCommand":{let e=this._context.globalState.get("startupCommands",[]);e.push({command:n.command,count:1}),await this._context.globalState.update("startupCommands",e),await this._saveWorkspaceConfig(),this.sendConfig();break}case"removeStartupCommand":{let e=this._context.globalState.get("startupCommands",[]);e.splice(n.index,1),await this._context.globalState.update("startupCommands",e),await this._saveWorkspaceConfig(),this.sendConfig();break}case"updateCommandCount":{let e=this._context.globalState.get("startupCommands",[]);e[n.index]&&(e[n.index].count=Math.max(1,n.count),await this._context.globalState.update("startupCommands",e)),await this._saveWorkspaceConfig(),this.sendConfig();break}case"addStep":{if(n.target==="all"){let e=this._context.globalState.get("defaultSteps",[]);e.push(n.step),await this._context.globalState.update("defaultSteps",e);let r=e.find(a=>a.type==="command");await this._context.globalState.update("defaultCommand",r?.input||"")}else{let e=this._context.globalState.get("cellOverrides",{}),r=n.target;e[r]||(e[r]={}),Array.isArray(e[r].startupSteps)||(e[r].startupSteps=[]),e[r].startupSteps.push(n.step);let a=e[r].startupSteps.find(d=>d.type==="command");e[r].startupCommand=a?.input||"",await this._context.globalState.update("cellOverrides",e)}await this._saveWorkspaceConfig(),this.sendConfig();break}case"removeStep":{if(n.target==="all"){let e=this._context.globalState.get("defaultSteps",[]);e.splice(n.index,1),await this._context.globalState.update("defaultSteps",e);let r=e.find(a=>a.type==="command");await this._context.globalState.update("defaultCommand",r?.input||"")}else{let e=this._context.globalState.get("cellOverrides",{}),r=n.target;if(Array.isArray(e[r]?.startupSteps)){e[r].startupSteps.splice(n.index,1);let a=e[r].startupSteps.find(d=>d.type==="command");e[r].startupCommand=a?.input||"",await this._context.globalState.update("cellOverrides",e)}}await this._saveWorkspaceConfig(),this.sendConfig();break}case"reorderSteps":{if(n.target==="all"){await this._context.globalState.update("defaultSteps",n.steps);let e=n.steps.find(r=>r.type==="command");await this._context.globalState.update("defaultCommand",e?.input||"")}else{let e=this._context.globalState.get("cellOverrides",{}),r=n.target;e[r]||(e[r]={}),e[r].startupSteps=n.steps;let a=n.steps.find(d=>d.type==="command");e[r].startupCommand=a?.input||"",await this._context.globalState.update("cellOverrides",e)}await this._saveWorkspaceConfig(),this.sendConfig();break}case"updateStep":{if(n.target==="all"){let e=this._context.globalState.get("defaultSteps",[]);n.index>=0&&n.index<e.length&&(e[n.index]=n.step,await this._context.globalState.update("defaultSteps",e))}else{let e=this._context.globalState.get("cellOverrides",{}),r=n.target,a=e[r]?.startupSteps||[];n.index>=0&&n.index<a.length&&(a[n.index]=n.step,e[r]||(e[r]={}),e[r].startupSteps=a,await this._context.globalState.update("cellOverrides",e))}await this._saveWorkspaceConfig(),this.sendConfig();break}case"addProject":{let e=this._context.globalState.get("projects",[]);e.some(r=>r.path===n.path)||(e.push({name:n.name,path:n.path}),await this._context.globalState.update("projects",e)),this.sendConfig();break}case"removeProject":{let e=this._context.globalState.get("projects",[]);e.splice(n.index,1),await this._context.globalState.update("projects",e),this.sendConfig();break}case"openProject":{let e=l.Uri.file(n.path);await l.commands.executeCommand("vscode.openFolder",e,{forceNewWindow:!!n.newWindow});break}case"addCurrentProject":{let e=l.workspace.workspaceFolders?.[0];if(!e){l.window.showWarningMessage(l.l10n.t("No workspace folder open."));break}let r=this._context.globalState.get("projects",[]),a=e.uri.fsPath;r.some(d=>d.path===a)||(r.push({name:e.name,path:a}),await this._context.globalState.update("projects",r)),this.sendConfig();break}case"browseProject":{let e=await l.window.showOpenDialog({canSelectFiles:!1,canSelectFolders:!0,canSelectMany:!1,title:l.l10n.t("Select Project Folder")});if(!e||e.length===0)break;let r=e[0].fsPath,a=L.basename(r),d=this._context.globalState.get("projects",[]);d.some(c=>c.path===r)||(d.push({name:a,path:r}),await this._context.globalState.update("projects",d)),this.sendConfig();break}case"savePreset":{let e=l.workspace.getConfiguration("terminalGrid"),r=n.rows||e.get("defaultRows",3),a=n.cols||e.get("defaultCols",3),d={name:n.name,rows:r,cols:a,startupCommands:this._context.globalState.get("startupCommands",[]),cellLabels:this._context.globalState.get("cellLabels",[]),zoomPercent:e.get("zoomPercent",100),fontFamily:e.get("fontFamily",""),bgColor:e.get("backgroundColor",""),fgColor:e.get("foregroundColor",""),colorTheme:e.get("colorTheme",""),shellType:e.get("shellType",""),defaultCommand:this._context.globalState.get("defaultCommand",""),defaultSteps:this._context.globalState.get("defaultSteps",[]),cellStepsOverrides:this._context.globalState.get("cellOverrides",{}),mergedRegions:this._context.globalState.get("mergedRegions",[])};if(l.workspace.workspaceFolders?.[0])await this._saveLocalPreset(n.name,d),await this._saveWorkspaceConfig(r,a),await this._linkPresetToProject(n.name);else{let c=this._context.globalState.get("presets",[]),u=c.findIndex(h=>h.name===n.name);u>=0?c[u]=d:c.push(d),await this._context.globalState.update("presets",c)}this.sendConfig(n.name);break}case"loadPreset":{let e=this._loadLocalPreset(n.name);if(e||(e=this._context.globalState.get("presets",[]).find(d=>d.name===n.name)),!e)break;await this._linkPresetToProject(n.name);let r=l.workspace.getConfiguration("terminalGrid");if(await r.update("defaultRows",e.rows,l.ConfigurationTarget.Global),await r.update("defaultCols",e.cols,l.ConfigurationTarget.Global),await r.update("zoomPercent",e.zoomPercent,l.ConfigurationTarget.Global),await r.update("fontFamily",e.fontFamily,l.ConfigurationTarget.Global),await r.update("backgroundColor",e.bgColor,l.ConfigurationTarget.Global),await r.update("foregroundColor",e.fgColor,l.ConfigurationTarget.Global),await r.update("colorTheme",e.colorTheme||"",l.ConfigurationTarget.Global),await r.update("shellType",e.shellType||"",l.ConfigurationTarget.Global),await this._context.globalState.update("startupCommands",e.startupCommands||[]),await this._context.globalState.update("cellLabels",e.cellLabels||[]),await this._context.globalState.update("defaultCommand",e.defaultCommand||""),e.defaultSteps?await this._context.globalState.update("defaultSteps",e.defaultSteps):e.defaultCommand?await this._context.globalState.update("defaultSteps",[{type:"command",input:e.defaultCommand}]):await this._context.globalState.update("defaultSteps",[]),e.cellStepsOverrides){let a=this._context.globalState.get("cellOverrides",{});for(let[d,c]of Object.entries(e.cellStepsOverrides)){a[Number(d)]||(a[Number(d)]={});let u=c;Array.isArray(u.startupSteps)&&(a[Number(d)].startupSteps=u.startupSteps)}await this._context.globalState.update("cellOverrides",a)}await this._context.globalState.update("mergedRegions",e.mergedRegions||[]),this.sendConfig(n.name);break}case"deletePreset":{l.workspace.workspaceFolders?.[0]&&await this._deleteLocalPreset(n.name);let r=this._context.globalState.get("presets",[]).filter(c=>c.name!==n.name);await this._context.globalState.update("presets",r);let a=this._context.globalState.get("projectPresets",{}),d=!1;for(let[c,u]of Object.entries(a))u===n.name&&(delete a[c],d=!0);d&&await this._context.globalState.update("projectPresets",a),await this._saveWorkspaceConfig(),this.sendConfig();break}case"broadcast":{f.currentPanel?f.currentPanel.broadcastInput(n.text):l.window.showWarningMessage(l.l10n.t("No terminal grid is open."));break}case"broadcastToCell":{if(f.currentPanel)for(let e of n.cellIds)f.currentPanel.sendInputToCell(e,n.text);else l.window.showWarningMessage(l.l10n.t("No terminal grid is open."));break}case"setCellConfig":{let e=this._context.globalState.get("cellOverrides",{});if(e[n.cellId]={bgColor:n.bgColor||"",fgColor:n.fgColor||"",fontFamily:n.fontFamily||"",themeName:n.themeName||"",shellType:e[n.cellId]?.shellType||""},await this._context.globalState.update("cellOverrides",e),f.currentPanel){let r=n.themeName?M(n.themeName):null;f.currentPanel.sendCellConfig(n.cellId,n.bgColor||"",n.fgColor||"",n.fontFamily||"",n.themeName||"",r)}await this._saveWorkspaceConfig();break}case"setShellForCell":{let e=this._context.globalState.get("cellOverrides",{});e[n.cellId]||(e[n.cellId]={}),e[n.cellId].shellType=n.shellType||"",await this._context.globalState.update("cellOverrides",e),f.currentPanel&&f.currentPanel.restartCell(n.cellId),await this._saveWorkspaceConfig();break}case"setDefaultCommand":{let e=n.command||"";await this._context.globalState.update("defaultCommand",e),await this._context.globalState.update("defaultSteps",e?[{type:"command",input:e}]:[]),await this._saveWorkspaceConfig(),this.sendConfig();break}case"setCellCommand":{let e=this._context.globalState.get("cellOverrides",{});e[n.cellId]||(e[n.cellId]={});let r=n.command||"";e[n.cellId].startupCommand=r,e[n.cellId].startupSteps=r?[{type:"command",input:r}]:[],await this._context.globalState.update("cellOverrides",e),await this._saveWorkspaceConfig(),this.sendConfig();break}case"clearAllCellOverrides":{await this._context.globalState.update("cellOverrides",{}),f.currentPanel&&f.currentPanel.clearCellOverrides(),await this._saveWorkspaceConfig();break}case"clearAllCellShells":{let e=this._context.globalState.get("cellOverrides",{});for(let r of Object.keys(e))e[parseInt(r)]&&(e[parseInt(r)].shellType="");await this._context.globalState.update("cellOverrides",e),await this._saveWorkspaceConfig();break}case"saveMergeRegions":{let e=n.regions||[];await this._context.globalState.update("mergedRegions",e);let r=f.currentPanel,a=n.rows??r?.getRows()??l.workspace.getConfiguration("terminalGrid").get("defaultRows",2),d=n.cols??r?.getCols()??l.workspace.getConfiguration("terminalGrid").get("defaultCols",3),c=new Set;for(let u of e)for(let h=u.startRow;h<u.startRow+u.rowSpan;h++)for(let b=u.startCol;b<u.startCol+u.colSpan;b++)h===u.startRow&&b===u.startCol||h<a&&b<d&&c.add(h*d+b);if(c.size>0){let u=this._context.globalState.get("cellOverrides",{}),h=this._context.globalState.get("cellLabels",[]),b=!1;for(let v of c)u[String(v)]&&(delete u[String(v)],b=!0),h[v]&&(h[v]="",b=!0);b&&(await this._context.globalState.update("cellOverrides",u),await this._context.globalState.update("cellLabels",h))}await this._saveWorkspaceConfig(),this.sendConfig();break}case"saveSectionStates":{await this._context.globalState.update("sectionStates",n.states);break}case"installNodePty":{try{await l.window.withProgress({location:l.ProgressLocation.Notification,title:l.l10n.t("Installing node-pty\u2026"),cancellable:!1},()=>new Promise((a,d)=>{Z.exec("npm install node-pty",{cwd:this._context.extensionPath},c=>{c?d(c):a()})})),this._view?.webview.postMessage({type:"ptyInstallResult",success:!0});let e=l.l10n.t("Reload Window");await l.window.showInformationMessage(l.l10n.t("node-pty installed successfully. Reload window to activate."),e)===e&&l.commands.executeCommand("workbench.action.reloadWindow")}catch(e){let r=e instanceof Error?e.message:String(e);l.window.showErrorMessage(l.l10n.t("node-pty install failed: {0}",r)),this._view?.webview.postMessage({type:"ptyInstallResult",success:!1})}break}}}),l.workspace.onDidChangeConfiguration(n=>{n.affectsConfiguration("terminalGrid")&&this.sendConfig()})}async _migrateSteps(){let t=!1,o=this._context.globalState.get("defaultSteps",[]),s=this._context.globalState.get("defaultCommand","");s&&o.length===0?(await this._context.globalState.update("defaultSteps",[{type:"command",input:s}]),await this._context.globalState.update("defaultCommand",""),t=!0):s&&o.length>0&&(await this._context.globalState.update("defaultCommand",""),t=!0);let n=this._context.globalState.get("cellOverrides",{});for(let r of Object.keys(n)){let a=n[Number(r)];if(!a)continue;let d=a.startupCommand,c=a.startupSteps;d&&(!c||c.length===0)?(a.startupSteps=[{type:"command",input:d}],delete a.startupCommand,t=!0):d&&c&&c.length>0&&(delete a.startupCommand,t=!0)}this._context.globalState.get("startupCommands",[]).length>0&&(await this._context.globalState.update("startupCommands",[]),t=!0),t&&await this._context.globalState.update("cellOverrides",n)}sendConfig(t){if(!this._view)return;this._migrateSteps();let o=l.workspace.getConfiguration("terminalGrid"),s=this._context.globalState.get("customFonts",[]),n=this._context.globalState.get("startupCommands",[]),e=this._context.globalState.get("projects",[]),r=this._listLocalPresets(),a=this._context.globalState.get("projectPresets",{}),d=this._context.globalState.get("cellLabels",[]),c=this._context.globalState.get("cellOverrides",{}),u=this._context.globalState.get("defaultSteps",[]),h=this._context.globalState.get("sectionStates",{}),b=l.workspace.workspaceFolders?.[0]?.uri.fsPath||"",v=f.currentPanel,m=f.getAvailableShells();this._view.webview.postMessage({type:"configValues",zoom:o.get("zoomPercent",100),fontFamily:o.get("fontFamily",""),bgColor:o.get("backgroundColor",""),fgColor:o.get("foregroundColor",""),colorTheme:o.get("colorTheme",""),shellType:o.get("shellType",""),defaultCommand:this._context.globalState.get("defaultCommand",""),themeNames:U,availableShells:m.map(C=>({name:C.name,path:C.path})),customFonts:s.map(C=>C.name),startupCommands:n,projects:e,presets:r,projectPresets:a,cellLabels:d,cellOverrides:c,defaultSteps:u,sectionStates:h,workspacePath:b,gridRows:v?.getRows()??0,gridCols:v?.getCols()??0,defaultRows:o.get("defaultRows",2),defaultCols:o.get("defaultCols",3),mergedRegions:this._context.globalState.get("mergedRegions",[]),hiddenCells:(()=>{let C=this._context.globalState.get("mergedRegions",[]),T=v?v.getCols():o.get("defaultCols",3),w=[];for(let S of C)for(let P=S.startRow;P<S.startRow+S.rowSpan;P++)for(let E=S.startCol;E<S.startCol+S.colSpan;E++)P===S.startRow&&E===S.startCol||w.push(P*T+E);return w})(),loadedPresetName:t||a[b]})}_getHtml(){let t=ve();return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta http-equiv="Content-Security-Policy"
...
</html>`}};function ve(){let i="",t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";for(let o=0;o<32;o++)i+=t.charAt(Math.floor(Math.random()*t.length));return i}var Y=k(require("http"));var j=class{constructor(t){this._server=null;this._port=t}start(t=10){return new Promise((o,s)=>{this._server=this._createServer();let n=e=>{this._server.removeAllListeners("error"),this._server.on("error",r=>{r.code==="EADDRINUSE"&&e<t?(this._port++,n(e+1)):s(r)}),this._server.listen(this._port,"127.0.0.1",()=>{let r=this._server.address();this._port=r.port,o(this._port)})};n(0)})}_createServer(){return Y.createServer((t,o)=>{if(o.setHeader("Content-Type","application/json"),t.method==="OPTIONS"){o.writeHead(204),o.end();return}let s=new URL(t.url||"/",`http://127.0.0.1:${this._port}`);t.method==="GET"&&s.pathname==="/api/health"?(o.writeHead(200),o.end(JSON.stringify({status:"ok"}))):t.method==="GET"&&s.pathname==="/api/info"?this._handleInfo(o):t.method==="POST"&&s.pathname==="/api/send"?this._readBody(t).then(n=>this._handleSend(n,o)):t.method==="POST"&&s.pathname==="/api/read"?this._readBody(t).then(n=>this._handleRead(n,o)):t.method==="POST"&&s.pathname==="/api/broadcast"?this._readBody(t).then(n=>this._handleBroadcast(n,o)):(o.writeHead(404),o.end(JSON.stringify({error:"Not found"})))})}stop(){this._server?.close(),this._server=null}getPort(){return this._port}_handleInfo(t){let o=f.currentPanel;if(!o){t.writeHead(200),t.end(JSON.stringify({grid:null}));return}t.writeHead(200),t.end(JSON.stringify({grid:{rows:o.getRows(),cols:o.getCols(),cellCount:o.getCellCount(),cellLabels:o.getCellLabels()}}))}_handleSend(t,o){let s=f.currentPanel;if(!s){o.writeHead(200),o.end(JSON.stringify({success:!1,error:"No grid open"}));return}let n=typeof t.cellId=="number"?t.cellId:-1,e=typeof t.text=="string"?t.text:"",a=t.submit===!0?s.sendInputToCell(n,e):s.sendToCell(n,e);o.writeHead(200),o.end(JSON.stringify({success:a}))}_handleRead(t,o){let s=f.currentPanel;if(!s){o.writeHead(200),o.end(JSON.stringify({output:null,error:"No grid open"}));return}let n=typeof t.cellId=="number"?t.cellId:-1,e=typeof t.lines=="number"?t.lines:void 0,r=s.readCell(n,e);o.writeHead(200),o.end(JSON.stringify({output:r}))}_handleBroadcast(t,o){let s=f.currentPanel;if(!s){o.writeHead(200),o.end(JSON.stringify({success:!1,error:"No grid open"}));return}let n=typeof t.text=="string"?t.text:"",e=t.submit===!0,r=s.getCellCount();if(e)s.broadcastInput(n);else for(let a=0;a<r;a++)s.sendToCell(a,n);o.writeHead(200),o.end(JSON.stringify({success:!0,cellCount:r}))}_readBody(t){return new Promise(o=>{let s="";t.on("data",n=>{s+=n}),t.on("end",()=>{try{o(JSON.parse(s))}catch{o({})}})})}};function be(i,t){return{command:"node",args:[_.join(i,"mcp-server.js")],env:{TERMINAL_GRID_PORT:String(t)}}}function K(i,t,o){try{let s=_.dirname(i);x.existsSync(s)||x.mkdirSync(s,{recursive:!0});let n={};x.existsSync(i)&&(n=JSON.parse(x.readFileSync(i,"utf-8"))),(!n.mcpServers||typeof n.mcpServers!="object")&&(n.mcpServers={}),n.mcpServers["terminal-grid"]=be(t,o),x.writeFileSync(i,JSON.stringify(n,null,2),"utf-8")}catch{}}function he(i,t,o){try{if(!x.existsSync(i))return;let s=JSON.parse(x.readFileSync(i,"utf-8")),n=s?.mcpServers;if(!n||typeof n!="object")return;let e=n["terminal-grid"];if(!e||!Array.isArray(e.args)||e.args.length===0)return;let r=_.join(t,"mcp-server.js");if(e.args[0]===r)return;e.args[0]=r,e.env={...e.env,TERMINAL_GRID_PORT:String(o)},x.writeFileSync(i,JSON.stringify(s,null,2),"utf-8")}catch{}}function X(i,t){try{let o=_.join(D.homedir(),".codex","config.toml"),s=_.join(i,"mcp-server.js").replace(/\\/g,"\\\\");if(x.existsSync(o)){let r=x.readFileSync(o,"utf-8");if(r.includes("[mcp_servers.terminal-grid]")){let a=r.replace(/(\[mcp_servers\.terminal-grid\][\s\S]*?args\s*=\s*\[")([^"]*)("])/,`$1${s}$3`);a!==r&&x.writeFileSync(o,a,"utf-8");return}}let n=`
...
`,e=_.dirname(o);x.existsSync(e)||x.mkdirSync(e,{recursive:!0}),x.appendFileSync(o,n,"utf-8")}catch{}}function Q(i,t){K(_.join(D.homedir(),".claude.json"),i,t);let o=process.platform==="win32"?process.env.APPDATA||_.join(D.homedir(),"AppData","Roaming"):process.platform==="darwin"?_.join(D.homedir(),"Library","Application Support"):_.join(D.homedir(),".config");K(_.join(o,"Claude","claude_desktop_config.json"),i,t);for(let s of p.workspace.workspaceFolders||[])he(_.join(s.uri.fsPath,".mcp.json"),i,t)}var F,O;function we(i){let t=p.workspace.workspaceFolders?.[0];if(t){let e=_.join(t.uri.fsPath,"terminal-grid","terminal-grid.json"),r=null;if(x.existsSync(e))try{r=JSON.parse(x.readFileSync(e,"utf-8"))}catch(a){console.error("Failed to parse local terminal-grid.json",a)}else{let d=i.globalState.get("projectPresets",{})[t.uri.fsPath];d&&(r=i.globalState.get("presets",[]).find(u=>u.name===d))}if(r){let a=p.workspace.getConfiguration("terminalGrid");if(a.update("defaultRows",r.rows,p.ConfigurationTarget.Global),a.update("defaultCols",r.cols,p.ConfigurationTarget.Global),a.update("zoomPercent",r.zoomPercent,p.ConfigurationTarget.Global),a.update("fontFamily",r.fontFamily,p.ConfigurationTarget.Global),a.update("backgroundColor",r.bgColor,p.ConfigurationTarget.Global),a.update("foregroundColor",r.fgColor,p.ConfigurationTarget.Global),a.update("colorTheme",r.colorTheme||"",p.ConfigurationTarget.Global),a.update("shellType",r.shellType||"",p.ConfigurationTarget.Global),i.globalState.update("startupCommands",r.startupCommands||[]),i.globalState.update("cellLabels",r.cellLabels||[]),i.globalState.update("defaultCommand",r.defaultCommand||""),r.defaultSteps?i.globalState.update("defaultSteps",r.defaultSteps):r.defaultCommand?i.globalState.update("defaultSteps",[{type:"command",input:r.defaultCommand}]):i.globalState.update("defaultSteps",[]),r.cellStepsOverrides){let d=i.globalState.get("cellOverrides",{});for(let[c,u]of Object.entries(r.cellStepsOverrides)){d[Number(c)]||(d[Number(c)]={});let h=u;Array.isArray(h.startupSteps)&&(d[Number(c)].startupSteps=h.startupSteps)}i.globalState.update("cellOverrides",d)}i.globalState.update("mergedRegions",r.mergedRegions||[])}}let o=new N(i),s=p.workspace.getConfiguration("terminalGrid").get("apiPort",7890);s>0&&(F=new j(s),F.start().then(e=>{O=p.window.createStatusBarItem(p.StatusBarAlignment.Right,50),O.text=`$(broadcast) TG :${e}`,O.tooltip=p.l10n.t("Terminal Grid API active on port {0}",e),O.command="terminalGrid.copyMcpConfig",O.show(),i.subscriptions.push(O),o.setMcpPort(e),Q(i.extensionPath,e),X(i.extensionPath,e)}).catch(e=>{p.window.showWarningMessage(p.l10n.t("Terminal Grid API bridge failed to start: {0}",e.message))}));let n=p.lm;if(typeof n?.registerMcpServerDefinitionProvider=="function"){let e=new p.EventEmitter,r=s,a=n.registerMcpServerDefinitionProvider;i.subscriptions.push(a("terminalGrid",{onDidChangeMcpServerDefinitions:e.event,provideMcpServerDefinitions:async()=>{if(r<=0)return[];let d=p.McpStdioServerDefinition;return d?[new d("Terminal Grid","node",[_.join(i.extensionPath,"mcp-server.js")],{TERMINAL_GRID_PORT:String(r)},i.extension.packageJSON.version)]:[]}}),e),i.subscriptions.push(p.workspace.onDidChangeConfiguration(d=>{d.affectsConfiguration("terminalGrid.apiPort")&&(r=p.workspace.getConfiguration("terminalGrid").get("apiPort",7890),e.fire())}))}i.subscriptions.push(p.workspace.onDidChangeConfiguration(e=>{if(e.affectsConfiguration("terminalGrid.apiPort")){let r=p.workspace.getConfiguration("terminalGrid").get("apiPort",7890);r>0&&(Q(i.extensionPath,r),X(i.extensionPath,r))}})),i.subscriptions.push(p.window.registerWebviewViewProvider(N.viewType,o)),i.subscriptions.push(p.commands.registerCommand("terminalGrid._refreshSidebar",()=>{o.sendConfig()})),i.subscriptions.push(p.window.registerWebviewPanelSerializer("terminalGrid",{async deserializeWebviewPanel(e,r){let a=i.globalState.get("lastGrid");a?f.revive(e,i,a.rows,a.cols):e.dispose()}})),i.subscriptions.push(p.commands.registerCommand("terminalGrid.openGrid",()=>{let e=p.workspace.getConfiguration("terminalGrid"),r=e.get("defaultRows",2),a=e.get("defaultCols",3);f.createOrShow(i,r,a)}),p.commands.registerCommand("terminalGrid.openCustomGrid",(e,r)=>{f.createOrShow(i,e,r)}),p.commands.registerCommand("terminalGrid.open2x2",()=>f.createOrShow(i,2,2)),p.commands.registerCommand("terminalGrid.open2x3",()=>f.createOrShow(i,2,3)),p.commands.registerCommand("terminalGrid.open3x3",()=>f.createOrShow(i,3,3)),p.commands.registerCommand("terminalGrid.sendToCell",(e,r)=>f.currentPanel?.sendToCell(e,r)??!1),p.commands.registerCommand("terminalGrid.readCell",(e,r)=>f.currentPanel?.readCell(e,r)??null),p.commands.registerCommand("terminalGrid.getGridInfo",()=>{let e=f.currentPanel;return e?{rows:e.getRows(),cols:e.getCols(),cellCount:e.getCellCount(),cellLabels:e.getCellLabels()}:null}),p.commands.registerCommand("terminalGrid.testAPI",async()=>{let e=p.window.createOutputChannel("Terminal Grid Tests");e.show(),e.appendLine(`=== Terminal Grid API Tests ===
`);let r=0,a=0;function d(w,S,P){let E=S?"PASS":"FAIL";S?r++:a++,e.appendLine(`[${E}] ${w}${P?" \u2014 "+P:""}`)}let c=await p.commands.executeCommand("terminalGrid.getGridInfo");if(!c){e.appendLine("[FAIL] getGridInfo returned null. Open a grid first.");return}d("getGridInfo returns object",!!c,JSON.stringify(c)),d("rows is number",typeof c.rows=="number",`rows=${c.rows}`),d("cols is number",typeof c.cols=="number",`cols=${c.cols}`),d("cellCount = rows*cols",c.cellCount===c.rows*c.cols,`${c.cellCount}`),d("cellLabels is array",Array.isArray(c.cellLabels),`length=${c.cellLabels.length}`),d("cellLabels.length = cellCount",c.cellLabels.length===c.cellCount);let u=await p.commands.executeCommand("terminalGrid.sendToCell",0,"echo __API_TEST__\r");d("sendToCell(0) returns true",u===!0);let h=await p.commands.executeCommand("terminalGrid.sendToCell",999,"x\r");d("sendToCell(999) returns false",h===!1,`got ${h}`);let b=await p.commands.executeCommand("terminalGrid.sendToCell",0,"TYPED_ONLY");d("sendToCell without \\r returns true",b===!0),await new Promise(w=>setTimeout(w,2e3)),await p.commands.executeCommand("terminalGrid.sendToCell",0,"");let v=await p.commands.executeCommand("terminalGrid.readCell",0);d("readCell(0) returns string",typeof v=="string",`length=${v?.length??0}`),d("readCell(0) contains test marker",!!v&&v.includes("__API_TEST__"));let m=await p.commands.executeCommand("terminalGrid.readCell",0,3);d("readCell(0, 3) returns string",typeof m=="string");let C=await p.commands.executeCommand("terminalGrid.readCell",0,0);d("readCell(0, 0) returns empty",C==="",`got "${C}"`);let T=await p.commands.executeCommand("terminalGrid.readCell",999);if(d("readCell(999) returns null",T===null,`got ${T}`),c.cellCount>1){let w=await p.commands.executeCommand("terminalGrid.sendToCell",1,"echo CELL1_OK\r");d("sendToCell(1) returns true",w===!0),await new Promise(P=>setTimeout(P,1500));let S=await p.commands.executeCommand("terminalGrid.readCell",1);d("readCell(1) contains CELL1_OK",!!S&&S.includes("CELL1_OK"))}e.appendLine(`
=== ${r} passed, ${a} failed ===`),a===0?p.window.showInformationMessage(p.l10n.t("Terminal Grid API: All {0} tests passed!",r)):p.window.showWarningMessage(p.l10n.t("Terminal Grid API: {0} test(s) failed. See output.",a))}),p.commands.registerCommand("terminalGrid.copyMcpConfig",()=>{let e=F?.getPort()??7890,a={mcpServers:{"terminal-grid":{command:"node",args:[_.join(i.extensionPath,"mcp-server.js")],env:{TERMINAL_GRID_PORT:String(e)}}}};p.env.clipboard.writeText(JSON.stringify(a,null,2)),p.window.showInformationMessage(p.l10n.t("Terminal Grid MCP config copied to clipboard (port {0})",e))}))}function ye(){F?.stop(),F=void 0,f.currentPanel?.dispose()}0&&(module.exports={activate,deactivate});
